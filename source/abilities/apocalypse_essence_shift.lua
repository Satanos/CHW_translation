        ...
        if params.attacker == self:GetParent() then
          if params.target:IsRealHero() then
                ...
                if self:GetParent():HasModifier("modifier_apocalypse_essence_shift_caster") then
                    ...
                    self:GetParent():AddNewModifier (self:GetCaster (), self:GetAbility (), "modifier_apocalypse_essence_shift_caster", {duration = self:GetAbility():GetSpecialValueFor("duration")})
                end
                ...
                if params.target:HasModifier("modifier_apocalypse_essence_shift_target") then
                    ...
                    params.target:AddNewModifier (self:GetCaster (), self:GetAbility (), "modifier_apocalypse_essence_shift_target", {duration = self:GetAbility():GetSpecialValueFor("duration")})
                end
