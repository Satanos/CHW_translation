            ...
            if self:GetCaster():HasScepter() then
                ...
                if #targets > 0 then
                    for _,target in pairs(targets) do
                        ...
                        local explosion = ParticleManager:CreateParticle("particles/death_eye.vpcf", PATTACH_WORLDORIGIN, caster)
                ...
                local nFXIndex = ParticleManager:CreateParticle( "particles/hero_ghost_rider/ghost_rider_punishing_gaze_agh.vpcf", PATTACH_WORLDORIGIN, self:GetCaster() )
