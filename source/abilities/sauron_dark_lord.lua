sauron_dark_lord = class ( {})

--------------------------------------------------------------------------------

function sauron_dark_lord:GetAOERadius ()
    return self:GetSpecialValueFor ("bolt_aoe")
end

--------------------------------------------------------------------------------

function sauron_dark_lord:OnAbilityPhaseStart ()
...
function sauron_dark_lord:OnSpellStart ()
...
function sauron_dark_lord:OnProjectileHit (hTarget, vLocation)
